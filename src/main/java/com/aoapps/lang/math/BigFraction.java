 ...
 * Copyright (C) 2010, 2011, 2016, 2017, 2021, 2022, 2024  AO Industries, Inc.
...
public class BigFraction extends Number implements Serializable, Comparable<BigFraction> {
  ...
  public int compareTo(BigFraction o) {
    ...
    if (denominator.compareTo(o.denominator) == 0) {
  ...
  private BigFraction reduce(BigInteger newNumerator, BigInteger newDenominator, boolean displayPercentage) {
    ...
    if (displayPercentage == this.displayPercentage && newNumerator.compareTo(numerator) == 0 && newDenominator.compareTo(denominator) == 0) {
      return this;
    }
   ...
   *
   * <p>If either is a percentage, the result will be a percentage.</p>
   */
   ...
   *
   * <p>If both are percentages, the result will be a percentage.</p>
   */
